...
const Circle =({bgc})=>{
    return(<div style={{marginRight:'0.5rem',width:'1.4rem',height:'1.4rem',borderRadius:'50%',backgroundColor:bgc}}></div>)
}
    ...
    return (
      <div style={{ width: "80%", margin: "0 auto" }}>
        ...
        <div style={{ margin: "0 auto", width: "80%" }}>
          ...
          <div style={{margin:'0.5rem auto',width:'max-content'}}> N {"->"} Number of Elements</div>
        </div>
      </div>
    );
}
